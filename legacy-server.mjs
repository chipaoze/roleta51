...
const SHOP_CATALOG = [
  ...
  { id: 'site-gta-neon', name: 'Coleção GTA 6: Neon Vice', description: 'Tema geral premium: cidade tropical em neon, cursor, rastro e nome combinando. Você pode trocar cada parte depois.', price: 1180, type: 'siteTheme', value: 'gta-neon', icon: '🌴', bundleItems: ['cursor-gta-neon','trail-gta-neon','name-gta-neon'] },
  { id: 'site-cobblemon', name: 'Coleção Cobblemon', description: 'Tema geral premium: mundo em blocos, criaturas no fundo, cursor, rastro e nome combinando. Você pode trocar cada parte depois.', price: 1080, type: 'siteTheme', value: 'cobblemon', icon: '⛏️', bundleItems: ['cursor-cobblemon','trail-cobblemon','name-cobblemon'] },
  { id: 'site-wolverine', name: 'Coleção Wolverine', description: 'Tema geral premium: metal escuro, amarelo, garras, cursor, rastro e nome combinando. Você pode trocar cada parte depois.', price: 1140, type: 'siteTheme', value: 'wolverine', icon: '🦾', bundleItems: ['cursor-wolverine','trail-wolverine','name-wolverine'] },
  ...
  { id: 'site-samurai', name: 'Coleção Samurai: Névoa de Yōtei', description: 'Tema geral premium: pôr do sol japonês, pétalas ao vento, cursor, rastro e nome combinando. Você pode trocar cada parte depois.', price: 1160, type: 'siteTheme', value: 'samurai', icon: '⛩️', bundleItems: ['cursor-samurai','trail-samurai','name-samurai'] },
  { id: 'site-god-war', name: 'Coleção God of War: Norte Antigo', description: 'Tema geral premium: gelo, runas, fogo e metal, com cursor, rastro e nome combinando. Você pode trocar cada parte depois.', price: 1160, type: 'siteTheme', value: 'god-war', icon: '🪓', bundleItems: ['cursor-god-war','trail-god-war','name-god-war'] },
