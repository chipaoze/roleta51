...
export const MARKET_UPDATE_HOURS = Object.freeze([0, 3, 6, 9, 12, 15, 18, 21]);

function slotKey(date = new Date()) {
  const parts = new Intl.DateTimeFormat('en-CA', { timeZone: MARKET_TIME_ZONE, year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', hour12: false }).formatToParts(date);
