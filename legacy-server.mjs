...
const SHOP_CATALOG = [
  ...
  { id: 'cursor-thor', name: 'Mjölnir Retornável', description: 'O martelo de Thor vira seu cursor. Pressione T para arremessar na direção do movimento; pressione T ou clique novamente para chamá-lo de volta.', price: 540, type: 'cursorStyle', value: 'thor', icon: '🔨' },
